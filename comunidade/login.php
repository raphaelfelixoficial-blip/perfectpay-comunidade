...
<title>Login — Comunidade Perfect Pay</title>
<?php render_favicon(); ?>
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  h1{font-family:'Bebas Neue',sans-serif;font-size:42px;letter-spacing:2px;line-height:1;margin-bottom:.5rem}
  h1 .gold{color:var(--br-yellow)}
  p{color:#999;font-size:14px;margin-bottom:1.5rem}
  ...
  .err{background:rgba(220,53,69,.15);border:1px solid #dc3545;color:#ff8a8a;padding:12px;border-radius:6px;font-size:13px;margin-bottom:1rem}
  .back{display:block;text-align:center;margin-top:1.25rem;color:#666;font-size:13px;text-decoration:none}
  .back:hover{color:var(--br-yellow)}
  .reset-link{display:block;text-align:center;margin-top:1rem;color:var(--br-yellow);font-size:13px;font-weight:600;text-decoration:none}
  .reset-link:hover{text-decoration:underline}
  .reset-link i{vertical-align:-2px;margin-right:4px}
</style>
</head>
<body>
  ...
  <form class="card" method="post" action="">
    <div class="badge"><i class="ti ti-lock"></i> Área de membros</div>
    <h1>Perfect Pay <span class="gold">VIP</span></h1>
    <p>Acesse com o e-mail autorizado e a senha enviada após a compra.</p>
