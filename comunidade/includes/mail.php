  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#050505;padding:32px 16px">
    <tr><td align="center">
      <table width="100%" style="max-width:560px;background:#141414;border:1px solid #2a2a2a;border-radius:8px">
        <tr><td style="background:linear-gradient(135deg,#009739,#002776);padding:24px;text-align:center">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#050505;padding:32px 16px">
    <tr><td align="center">
      <table width="100%" style="max-width:560px;background:#141414;border:1px solid #2a2a2a;border-radius:8px;overflow:hidden">
        <tr><td style="background:linear-gradient(135deg,#009739,#002776);padding:28px 24px;text-align:center">
        ...
        <tr><td style="padding:28px 24px">
          ...
          <p style="text-align:center;margin:0 0 12px">
            <a href="{$safeAlbuns}" style="display:inline-block;background:linear-gradient(135deg,#009739,#007a2f);color:#fff;text-decoration:none;font-weight:bold;padding:14px 28px;border-radius:4px;font-size:15px;margin:4px">📚 VER PDFs ONLINE</a>
          </p>
          <p style="text-align:center;margin:0">
