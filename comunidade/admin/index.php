...
<div class="wrap">
  ...
  <div class="card">
    ...
    <p class="hint" style="margin-top:.75rem"><strong>E-mail no spam?</strong> Configure SMTP como <code>mail.agenciajob.com</code> porta <code>465</code> (SSL), usuário <code>noreply@agenciajob.com</code>. No cPanel, corrija DKIM/SPF/DMARC do domínio <strong>agenciajob.com</strong> (não os subdomínios concursos/editor). Aviso em <code>perfectpay.agenciajob.com</code> no painel é normal — o DNS do subdomínio fica no registro principal.</p>
